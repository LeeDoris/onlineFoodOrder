    ...
    <div id="main">
        <div id="header">
            ...
            <ul id="top-navigation">
                ...
                <li style="position:relative;left:275px;"><span><span><a href="../logOut.php">Logout</a></span></span>
                </li>
                <li style="position:relative;left:275px;;"><span><span><a
                                href="../index.php">View Site</a></span></span></li>
            </ul>
        </div>
        <div id="middle">
            <div id="left-column">
            ...
            <div id="center-column">
                ...
                <div class="table">
                    ...
                    <table class="listing table-autosort" id="tdfiltering" cellpadding="0" cellspacing="0">
                        <thead>
                        <tr>
                            <th class="first table-sortable:numeric" width="10">ID<img src="../images/arrow.png"
                                                                                       alt="Sortable"/></th>
                            <th class="table-sortable:asc">Content Name<span></span><img src="../images/arrow.png"
                                                                                         alt="Sortable"/></th>
                            <th class="table-sortable:date">Post Time<span></span><img src="../images/arrow.png"
                                                                                       alt="Sortable"/></th>
                            <th class="table-sortable:asc">Category<span></span><img src="../images/arrow.png"
                                                                                     alt="Sortable"/></th>
                            <th class="table-sortable:asc">Description<span></span><img src="../images/arrow.png"
                                                                                        alt="Sortable"/></th>
                        ...
                        while ($rownumR = mysqli_fetch_array($resultR)) {
                            ...
                            <td><?php echo $desc; ?></td>
                            <td class="last">
                                <a href="updateForm.php?content_id=<?php echo $content_id; ?>"><img
                                        src="img/page_edit.png" width="16" height="16" alt="Edit"/></a>
                                <a href="deleteRecord.php?content_id=<?php echo $content_id; ?>"><img
                                        src="img/cancel.png" width="16" height="16" alt="Delete"/></a>
                            </td>
                ...
                <form enctype="multipart/form-data" method="post"
                      action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" id="form" name="form">
                    <table>
                        <tr>
                            <td>Title:</td>
                            <td><input type="text" name="name"/><i><span style="font-size: 10px; margin-left:10px;"
                                                                         id='form_name_errorloc'
                                                                         class="error_strings"></span></i></td>
                        </tr>
                        <tr>
                            <td>Start Time:</td>
                            <td><input id="start_time" name="start_time" type="text" size="25" readonly="readonly"/><a
                                    href="javascript:NewCal('start_time','ddmmyyyy')"><img src="../images/cal.gif"
                                                                                           width="20" height="18"
                                                                                           border="1"
                        ...
                        <tr>
                            <td>End Time:</td>
                            <td><input id="end_time" name="end_time" type="text" size="25" readonly="readonly"/><a
                                    href="javascript:NewCal('end_time','ddmmyyyy')"><img src="../images/cal.gif"
                                                                                         width="20" height="18"
                                                                                         border="1" alt="Pick a date"/></a>
                            </td>
                        </tr>
                        <tr>
                            <td><input type="hidden" name="post_time" value="<?php echo date('Y-m-d H:i', time()); ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <td>Category:</td>
                        ...
                        <tr>
                            <td>Description:</td>
                            <td><textarea rows="5" cols="30" name="description"></textarea><i><span
                                        style="font-size: 10px; margin-left:10px;" id='form_description_errorloc'
                                        class="error_strings"></span></i></td>
                        </tr>
                        <tr>
                            <td>Image:</td>
