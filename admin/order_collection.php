...
$queryNum = "SELECT COUNT(*) FROM orders WHERE (type='self_collection' AND date LIKE '$date%') AND state='Ready_for_collection' ";
...
$pages->mid_range = 9;  
$pages->paginate();
$queryNum = "SELECT * FROM orders WHERE (type='self_collection' AND date LIKE '$date%') AND state='Ready_for_collection' ORDER BY date DESC $pages->limit ";
} else{
$queryNum = "SELECT * FROM orders WHERE (type='self_collection' AND date LIKE '$date%') AND state='Ready_for_collection'  ORDER BY date DESC ";
}
				...
				<table class="listing table-autosort" id="tdfiltering" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<th class="table-sortable:date">Collection Time<span></span><img src="../images/arrow.png" alt="Sortable"/></th>
                                                <th class="table-sortable:numeric">Total Price<span></span><img src="../images/arrow.png" alt="Sortable"/></th>
                      ...
                      ?>
                          ...
                          <td class="last">
                               <a href="quickPass.php?order_id=<?php echo $order_id;?>&from=counter" onclick="return confirm('Are you sure this order is collected?')" ><img src="img/accept.png" width="16" height="16" title="Finish" /></a>
