        ...
        <div id="middle">
            ...
            <div id="center-column">
                ...
                <div style="margin-top:30px; border: 1px solid #9097A9;">
                    ...
                    <p>You have received <a href="orders.php"
                                            style="text-decoration:underline;"><b><?php echo $num_rows[0]; ?></b></a>
                        orders and <a href="reservation.php"
                                      style="text-decoration:underline;"><b><?php echo $num[0]; ?></b></a> reservations
                        for today.</p>
                    <p>You have <a href="orders.php"
                                   style="text-decoration:underline;"><b><?php echo $num_rowsOP[0]; ?></b></a> orders
                        and <a href="reservation.php" style="text-decoration:underline;"><b><?php echo $numRP[0]; ?></b></a>
                        reservations need to process.</p>
                </div>

                <div style="margin-top:30px; border: 1px solid #9097A9;">
                    <h2 style="background:#9097A9; text-align: center;color: white; margin: 0px 0px 0px 0px; height:25px;">
                        Order and Reservation For This Week</h2>
                ...
                <div class="table"
                     style="float: left; left:50px;margin-top:30px; border: 1px solid #9097A9; width: 280px;">
                    <h2 style="background:#9097A9; text-align: center;color: white; margin: 0px 0px 0px 0px; height:25px;">
                        Orders for this week</h2>
                    <br/>
                    <table width="280px;">
                        <thead style="background:#9097A9;">
                        <tr>
