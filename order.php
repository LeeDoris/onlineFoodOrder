                ...
                <div id="content_wrapper">
                    <div id="content">
                                ...
                                <div class="section_w590_content">
                                    ...
                                    <table cellpadding="12" class="productWrap">
                                        ...
                                        while ($item = mysqli_fetch_array($resultItem)) {
                                            ...
                                            ?>
                                            <tr>
                                                <td><a href="food_detail.php?itemid=<?php echo $id; ?>"
                                                       onclick="OpenPopup(this.href); return false"><?php echo $itemname; ?></a></label>
                                                    <input type="hidden" name="order_code" value="<?php echo $id; ?>"/>
                                                </td>
                                                <td><?php echo $itemp ?></td>
                                                <td>
                                                    <a href="cart_action.php?order_code=<?php echo $id; ?>&quantity=1&TB_iframe=true&height=400&width=780"
                                                       class="thickbox"><img src="images/add-to-basket2.gif"
                                                                             alt="Add To Basket" width="111"
                                                                             height="32"/></a></td>
                                            </tr>
                                            <?php
                                        }
                        ...
                        <div id="side_column">
                            ...
                            <h4><a href="cart.php?KeepThis=true&TB_iframe=true&height=400&width=780"
                                   title="Your Shopping Cart" class="thickbox">View Details</a></h4>
                            ...
                            <form method="post" action="order_confirm.php" name="orders" id="orders">
                                ...
                                <input id="date" name="date" type="text" size="16" readonly="readonly"/><a
                                    href="javascript:NewCal('date','ddmmyyyy','true','24')"><img src="images/cal.gif"
                                                                                                 width="16" height="16"
                                                                                                 border="0"
                                                                                                 alt="Pick a date"/></a>
                                <br/><i><span style="font-size: 10px; margin-left:10px;" id='orders_date_errorloc'
                                              class="error_strings"></span></i>
                                <br/>
                                <small><i> - Use Date Picker to set your collection time.</i></small>
                                <br/><br/>
                                <input type="checkbox" name="terms" value="Yes"/>I <b>agree</b> with this <a
                                    href="termsandconditions.php?type=order"
                                    onclick="OpenPopup(this.href); return false">Terms and Condition</a>
                                <br/><i><span style="font-size: 10px; margin-left:10px;" id='orders_terms_errorloc'
                                              class="error_strings"></span></i><br/>
