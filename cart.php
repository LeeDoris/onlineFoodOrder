        ...
        <form action="cart_action.php" method="get">
            <table id="cart">
                ...
                <tr>
                    ...
                    <td class="quantity center"><input type="text" name="quantity[<?php echo $order_code; ?>]" size="3"
                                                       value="<?php echo $quantity; ?>" tabindex="<?php echo $i; ?>"/>
                    </td>
                    <td class="item_name"><?php echo $name; ?></td>
                    <td class="unit_price">$<?php echo $up; ?></td>
                    <td class="extended_price">$<?php echo round($ep, 2); ?></td>
                    <td class="remove center"><input type="checkbox" name="remove[]"
                                                     value="<?php echo $order_code; ?>"/></td>
                </tr>
                <?php endforeach; ?>
                <tr>
                    <td colspan="4"></td>
                    <td id="total_price">$<?php echo number_format((float)$total_price, 2, '.', ''); ?></td>
                </tr>
            </table>
