                                ...
                                <div class="section_w590">
                                    ...
                                    <div class="section_w590_content">
                                        ...
                                        <form name="form" method="post" action="confirm.php">
                                            <label>Order ID:<input name="order_id" size="5" readonly="readonly"
                                                                   value="<?php echo $order_id; ?>"
                                                                   type="hidden"/><b><?php echo $order_id; ?></b></label>
                                            <table border="1">
                                                <col width="300"/>
                                                <col width="80"/>
                                                <col width="80"/>
                                                ...
                                                <tfoot>
                                                <tr>
                                                    <td colspan="4"><em>This is your order summary. No cancelation 2
                                                            HOURS BEFORE your collection time.</em></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="hidden" name="item[<?php echo $n_i; ?>][name]"
                                                               value="<?php echo $order_code; ?>"/><?php echo $name; ?>
                                                    </td>
                                                    <td><input type="hidden" name="item[<?php echo $n_i; ?>][quantity]"
                                                               value="<?php echo $quantity; ?>"/><?php echo $quantity; ?>
                                                    </td>
                                                    <td><input type="hidden" name="item[<?php echo $n_i; ?>][price]"
                                                               value="<?php echo $u_price; ?>"/>$<?php echo $u_price; ?>
                                                    </td>
                                                    <td><input type="hidden" name="item[<?php echo $n_i; ?>][t_p]"
                                                               value="<?php echo $i_price; ?>"/>$<?php echo $i_price; ?>
                                                    </td>
                                                </tr>
                                                <?php endforeach; ?>
                                                <tr>
                                                    ...
                                                    <td colspan="2"></td>
                                                    <td class="total" id="total_price"><input type="hidden"
                                                                                              name="total_price"
                                                                                              value="<?php echo round($total_price, 2); ?>"/>$<?php echo round($total_price, 2); ?>
                                                    </td>
                                                </tr>
                                                <?php if ($total_price >= 100) { ?>
                                                    <tr>
                                                        <td colspan="4">Notice: For orders $100.00 and above,we require
                                                            50% deposit. Otherwise your order wouldn't be accepted.
                                                        </td>
                                                    </tr>
                                                <?php }
                                                ?>
                                            ...
                                            Collection Time: <label id="collect"><input type="hidden" name="date"
                                                                                        value="<?php echo $collection_date = date('Y-m-d H:i', strtotime($showdate)); ?>"/><?php echo $showdate; ?>
                                            </label><br/>
                                            <br/><input type="hidden" name="c_date"
                                                        value="<?php echo $currentdate; ?>"/>
                                            <label>Collection Type:</label>&nbsp&nbsp<input type="radio" name="type"
                                                                                            value="self_collection"
                                                                                            checked/>Self Collection
                                            <input type="radio" name="type" value="delivery"/> Delivery ($5)
                                            <br/><br/>
                                            <fieldset id="address_box">
                                                <input type="text" placeholder="Address" name="address" size="60"
                                                       autofocus/>-
                                                <input type="text" placeholder="Postcode" size="6" name="postcode"/>
                                            </fieldset>
                                            <br/>
                                            <input id="button" type="submit"
                                                   value="Confirm <?php echo $disable; ?>" <?php echo $disable; ?> />
                                            <input id="button" type="button" value="Cancel"
                                                   onClick="window.location.href='clear.php'"/>
                                        </form>
